  ...
  extends AbstractTool
{
  ...
  public void apply()
  {
    if ((this.mChart instanceof XYChart))
    {
      ...
      if (k < i) {
        arrayOfDouble1 = new double[] { Double.MAX_VALUE, -1.7976931348623157E308D, Double.MAX_VALUE, -1.7976931348623157E308D };
      }
      for (int m = 0;; m++)
      {
        if (m >= j)
...
/* Location:              C:\Users\Anj\Desktop\Clone Test\dex2jar-0.0.9.15\classes_dex2jar.jar!\org\achartengine\tools\FitZoom.class
