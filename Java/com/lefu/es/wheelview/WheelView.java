  ...
  extends View
{
  ...
  private int getMaxTextLength()
  {
    ...
    for (int k = Math.max(this.currentItem - j, 0);; k++)
    {
      ...
      if ((str != null) && ((localObject == null) || (((String)localObject).length() < str.length()))) {
        localObject = str;
      }
    }
  }
  ...
  private void initResourcesIfNecessary()
  {
    ...
    if (this.centerDrawable == null) {
      this.centerDrawable = getContext().getResources().getDrawable(2130837710);
    }
    ...
    setBackgroundResource(2130837709);
  }
...
/* Location:              C:\Users\Anj\Desktop\Clone Test\dex2jar-0.0.9.15\classes_dex2jar.jar!\com\lefu\es\wheelview\WheelView.class
