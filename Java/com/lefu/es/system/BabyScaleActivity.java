  ...
  implements Runnable
{
  ...
  View.OnClickListener btnOnClickListener = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      ...
      localIntent.setClass(BabyScaleActivity.this, UserListActivity.class);
      BabyScaleActivity.this.startActivity(localIntent);
    }
  };
  ...
  Handler handler = new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      case 0: 
        ...
        } while ((!TextUtils.isEmpty(UtilConstants.FIRST_INSTALL_BABY)) || (CacheHelper.recordListDesc.size() <= 0));
      ...
      try
      {
        ...
        ExitApplication.getInstance().exit(BabyScaleActivity.this);
        Intent localIntent = new Intent();
        localIntent.setClass(BabyScaleActivity.this, LoadingActivity.class);
        BabyScaleActivity.this.startActivity(localIntent);
        return;
      }
  ...
  View.OnClickListener imgOnClickListener = new View.OnClickListener()
  {
    ...
    {
      Intent localIntent = new Intent();
      localIntent.setClass(BabyScaleActivity.this, RecordListActivity.class);
      localIntent.putExtra("type", 0);
      localIntent.addFlags(131072);
      BabyScaleActivity.this.startActivityForResult(localIntent, 0);
    }
  };
  ...
  private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver()
  {
    public void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              BabyScaleActivity.this.scale_connect_state.setText(2131361917);
            } while (!BabyScaleActivity.this.singleton.getmConnected());
            BabyScaleActivity.this.singleton.setmConnected(false);
            if (BabyScaleActivity.this.mBluetoothLeService != null)
            {
              boolean bool = BabyScaleActivity.this.mBluetoothLeService.connect(BluetoolUtil.mDeviceAddress);
            ...
            BabyScaleActivity.this.sendCodeCount = 0;
            BabyScaleActivity.this.scale_connect_state.setText(2131361916);
            AppData.hasCheckData = true;
            Toast.makeText(BabyScaleActivity.this, BabyScaleActivity.this.getString(2131361910), 1).show();
            Toast.makeText(BabyScaleActivity.this, BabyScaleActivity.this.getString(2131361910), 1).show();
          } while (BabyScaleActivity.this.mBluetoothLeService == null);
          new Thread(new Runnable()
          {
            public void run()
            {
              if ((BabyScaleActivity.this.singleton.getmConnected()) && (BabyScaleActivity.this.mBluetoothLeService != null)) {
        ...
        if (str2.equals(UtilConstants.ERROR_CODE)) {
          if (BabyScaleActivity.this.sendCodeCount <= 2)
          {
            ...
            BabyScaleActivity localBabyScaleActivity = BabyScaleActivity.this;
            localBabyScaleActivity.sendCodeCount = (1 + localBabyScaleActivity.sendCodeCount);
            if (System.currentTimeMillis() - UtilConstants.receiveDataTime < 1000L) {
              break label489;
            }
            UtilConstants.receiveDataTime = System.currentTimeMillis();
            if ((str2.startsWith(UtilConstants.BABY_SCALE)) || (str2.length() <= 31)) {
              break label574;
            }
            ...
            RecordDao.dueDate(BabyScaleActivity.this.recordService, str2);
          }
        }
        for (;;)
        {
          ...
          return;
          Toast.makeText(BabyScaleActivity.this, BabyScaleActivity.this.getString(2131361909), 0).show();
          break label341;
          if (!str2.equals(UtilConstants.ERROR_CODE_TEST)) {
            break label341;
          }
          Toast.makeText(BabyScaleActivity.this, BabyScaleActivity.this.getString(2131361912), 0).show();
          break label341;
          break;
          ...
          else if (str2.startsWith(UtilConstants.KITCHEN_SCALE))
          {
            ...
            UtilConstants.CURRENT_USER.setScaleType(UtilConstants.CURRENT_SCALE);
            RecordDao.dueKitchenDate(BabyScaleActivity.this.recordService, str2, null);
          }
        }
      ...
      BabyScaleActivity.this.dueDate(str2);
    }
  };
  private final BroadcastReceiver mReceiver = new BroadcastReceiver()
  {
    public void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
    {
      ...
      if ("android.bluetooth.device.action.FOUND".equals(str1))
      {
        ...
        if (localBluetoothDevice != null)
        {
          ...
          if ((str2 != null) && (str2.equalsIgnoreCase("Electronic Scale")))
          {
            ...
            BabyScaleActivity.this.handler.postDelayed(BabyScaleActivity.this.ScanRunnable, 15000L);
          }
        }
      }
      ...
      BabyScaleActivity.this.stopDiscovery();
      BabyScaleActivity.this.handler.postDelayed(BabyScaleActivity.this.ScanRunnable, 10000L);
    }
  };
  public final ServiceConnection mServiceConnection = new ServiceConnection()
  {
    ...
    {
      BabyScaleActivity.this.mBluetoothLeService = ((BluetoothLeService.LocalBinder)paramAnonymousIBinder).getService();
      ...
      BabyScaleActivity.this.isServiceReg = true;
    }
    
    public void onServiceDisconnected(ComponentName paramAnonymousComponentName)
    {
      BabyScaleActivity.this.mBluetoothLeService = null;
      BabyScaleActivity.this.isServiceReg = false;
    }
  };
  View.OnClickListener menuBtnOnClickListener = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      ...
      case 2131165226: 
        ...
        localIntent2.setClass(BabyScaleActivity.this, InfoActivity.class);
        BabyScaleActivity.this.startActivity(localIntent2);
        return;
      case 2131165227: 
        Intent localIntent1 = new Intent();
        localIntent1.setFlags(268435456);
        localIntent1.setClass(BabyScaleActivity.this, SettingActivity.class);
        BabyScaleActivity.this.startActivity(localIntent1);
        return;
      }
      BabyScaleActivity.this.dialog(BabyScaleActivity.this.getString(2131361845), paramAnonymousView.getId());
    }
  };
  ...
  private void initView()
  {
    ...
    this.pager.setOnPageChangeListener(new ViewPager.OnPageChangeListener()
    {
      ...
      public void onPageSelected(int paramAnonymousInt)
      {
        ...
        {
          if ((paramAnonymousInt == -1 + BabyScaleActivity.this.views.size()) || (paramAnonymousInt == 0)) {
            if (paramAnonymousInt == 0)
            {
              BabyScaleActivity.this.pager.setCurrentItem(paramAnonymousInt + 1);
              if (BabyScaleActivity.this.pager.getCurrentItem() >= 2) {
                break label226;
              }
              BabyScaleActivity.this.leftImg.setImageDrawable(BabyScaleActivity.this.getResources().getDrawable(2130837602));
            }
          }
          for (;;)
          {
            ...
            BabyScaleActivity.this.rightImg.setImageDrawable(BabyScaleActivity.this.getResources().getDrawable(2130837641));
            return;
            BabyScaleActivity.this.pager.setCurrentItem(paramAnonymousInt - 1);
            break;
            if (paramAnonymousInt > 0) {}
            for (BabyScaleActivity.this.selectedPosition = (paramAnonymousInt - 1);; BabyScaleActivity.this.selectedPosition = 0)
            {
              BabyScaleActivity.this.curRecord = ((Records)CacheHelper.recordListDesc.get(BabyScaleActivity.this.selectedPosition));
  ...
  private void setViews()
  {
    ...
    for (;;)
    {
      ...
      localLayoutParams2.setMargins((int)UtilTooth.changeBMIBaby(this.curRecord.getRbmi(), k), 0, 0, 0);
    ...
    localLayoutParams1.setMargins((int)UtilTooth.changeBMIBaby(0.0F, DisplayUtil.getWidth(this) - i), 0, 0, 0);
  ...
  private void showTipMask()
  {
    ...
    this.guideView = GuideView.Builder.newInstance(this).setTargetView(this.pager).setCustomGuideView(localTextView).setDirction(GuideView.Direction.BOTTOM).setShape(GuideView.MyShape.CIRCULAR).setBgColor(getResources().getColor(2131230720)).setRadius(200).setOnclickListener(new GuideView.OnClickCallback()
    {
      ...
      {
        BabyScaleActivity.this.guideView.hide();
        if (UtilConstants.su == null) {
          UtilConstants.su = new SharedPreferencesUtil(BabyScaleActivity.this);
        }
        UtilConstants.su.editSharedPreferences("lefuconfig", "first_install_baby", "1");
        UtilConstants.FIRST_INSTALL_BABY = "1";
      }
    }).build();
    this.guideView.show();
  }
  ...
  public View creatView(Records paramRecords, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        ...
        localMyTextView.setTexts(UtilTooth.kgToLB(paramRecords.getRweight()), null);
      } while (localTextView1 == null);
  ...
  protected void dialog(String paramString, final int paramInt)
  {
    ...
    localBuilder.setPositiveButton(2131361852, new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
      {
        ...
        paramAnonymousDialogInterface.dismiss();
        return;
        if (BabyScaleActivity.this.curRecord != null) {
          BabyScaleActivity.this.recordService.delete(BabyScaleActivity.this.curRecord);
        }
        CacheHelper.recordListDesc = BabyScaleActivity.this.recordService.getAllDatasByScaleAndIDDesc(UtilConstants.CURRENT_USER.getScaleType(), BabyScaleActivity.this.ItemID, 167.0F);
        if ((CacheHelper.recordListDesc != null) && (CacheHelper.recordListDesc.size() > 0)) {}
        for (BabyScaleActivity.this.curRecord = ((Records)CacheHelper.recordListDesc.get(0));; BabyScaleActivity.this.curRecord = null)
        {
...
/* Location:              C:\Users\Anj\Desktop\Clone Test\dex2jar-0.0.9.15\classes_dex2jar.jar!\com\lefu\es\system\BabyScaleActivity.class
