  ...
  extends FieldSerializer
{
    ...
    throws Exception
  {
    ...
    label89:
    for (this.runtimeFieldClass = getMethod().getReturnType();; this.runtimeFieldClass = paramObject.getClass())
    {
...
/* Location:              C:\Users\Anj\Desktop\Clone Test\dex2jar-0.0.9.15\classes_dex2jar.jar!\com\alibaba\fastjson\serializer\ObjectFieldSerializer.class
