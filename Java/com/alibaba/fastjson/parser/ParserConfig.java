...
public class ParserConfig
{
  ...
  public ObjectDeserializer getDeserializer(Class<?> paramClass, Type paramType)
  {
    ...
    try
    {
      ...
      ObjectDeserializer localObjectDeserializer3;
      localObject = new EnumDeserializer(paramClass);
    }
    catch (Exception localException)
    {
      localObjectDeserializer3 = (ObjectDeserializer)this.derializers.get(paramType);
    ...
    for (;;)
    {
      ...
      if ((paramClass == Set.class) || (paramClass == HashSet.class) || (paramClass == Collection.class) || (paramClass == List.class) || (paramClass == ArrayList.class))
      {
        ...
        {
          Type localType1 = ((ParameterizedType)paramType).getActualTypeArguments()[0];
          if (localType1 == String.class) {
            localObject = ArrayListStringDeserializer.instance;
          } else {
            localObject = new ArrayListTypeDeserializer(paramClass, localType1);
          }
        }
        else
        {
...
/* Location:              C:\Users\Anj\Desktop\Clone Test\dex2jar-0.0.9.15\classes_dex2jar.jar!\com\alibaba\fastjson\parser\ParserConfig.class
