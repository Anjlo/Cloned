  ...
  implements Opcodes
{
      ...
      for (;;)
      {
        ...
        else
        {
          if (Collection.class.isAssignableFrom(localClass))
          {
            ...
            _isFlag(paramMethodVisitor, paramContext, i, localLabel1);
            paramMethodVisitor.visitVarInsn(25, paramContext.var("instance"));
          ...
          _isFlag(paramMethodVisitor, paramContext, i, localLabel2);
          paramMethodVisitor.visitVarInsn(25, paramContext.var("instance"));
          paramMethodVisitor.visitVarInsn(25, paramContext.var(localFieldInfo.getName() + "_asm"));
          _batchSetInvoke(paramContext, paramMethodVisitor, localFieldInfo);
  ...
  private void _batchSetInvoke(Context paramContext, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo)
  {
  ...
  private void _init(ClassWriter paramClassWriter, Context paramContext)
  {
    ...
    while (n < i1)
    {
      ...
      localMethodVisitor.visitMethodInsn(182, ASMUtils.getType(String.class), "toCharArray", "()" + ASMUtils.getDesc(char[].class));
  ...
  private void _loadCreatorParameters(Context paramContext, MethodVisitor paramMethodVisitor)
  {
  ...
  void _deserialze(ClassWriter paramClassWriter, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (Collection.class.isAssignableFrom(localClass5)) {
        if ((!(localType3 instanceof ParameterizedType)) || (!(((ParameterizedType)localType3).getActualTypeArguments()[0] instanceof Class))) {
          break;
        }
      }
    }
    ...
    else
    {
      ...
      int i6 = arrayOfClass2.length;
      i7 = 0;
      label4206:
      if (i7 >= i6) {
        break label4418;
      }
      Class localClass2 = arrayOfClass2[i7];
    ...
    for (;;)
    {
      int i4 = paramContext.getVariantCount();
      localMethodVisitor.visitMaxs(n, i4);
      localMethodVisitor.visitEnd();
      return;
      label4454:
      Method localMethod1 = paramContext.getBeanInfo().getFactoryMethod();
      if (localMethod1 != null)
      {
        int i1 = 2;
        Class[] arrayOfClass1 = localMethod1.getParameterTypes();
        int i2 = arrayOfClass1.length;
        int i3 = 0;
        if (i3 < i2)
        {
  ...
  public FieldDeserializer createStringFieldDeserializer(ParserConfig paramParserConfig, Class<?> paramClass, FieldInfo paramFieldInfo)
    throws Exception
  {
    Class localClass1 = paramFieldInfo.getFieldClass();
    ...
    {
      localClass2 = IntegerFieldDeserializer.class;
      if (!paramClass.isInterface()) {
        break label497;
      }
      i = 185;
      label54:
      localClassWriter.visit(49, 33, str, ASMUtils.getType(localClass2), null);
      ...
      localMethodVisitor1.visitMethodInsn(183, ASMUtils.getType(localClass2), "<init>", "(" + ASMUtils.getDesc(ParserConfig.class) + ASMUtils.getDesc(Class.class) + ASMUtils.getDesc(FieldInfo.class) + ")V");
    ...
    for (;;)
    {
      ...
      {
        localClass2 = LongFieldDeserializer.class;
        break;
      }
      localClass2 = StringFieldDeserializer.class;
      break;
      label497:
      i = 182;
      break label54;
      ...
      else
      {
        ...
        localMethodVisitor2.visitTypeInsn(192, ASMUtils.getType(localClass1));
...
/* Location:              C:\Users\Anj\Desktop\Clone Test\dex2jar-0.0.9.15\classes_dex2jar.jar!\com\alibaba\fastjson\parser\deserializer\ASMDeserializerFactory.class
